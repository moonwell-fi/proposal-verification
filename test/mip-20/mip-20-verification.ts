...
const FORK_BLOCK = 2_758_890

test("mip-20-verifications", async () => {
    ...
    try {
        ...
        // Go pass proposal currently in timelock
        console.log('[+] Passing MIP-19...')
        await passLatestGovProposal(contracts, provider)
