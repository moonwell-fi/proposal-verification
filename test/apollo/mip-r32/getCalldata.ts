...
async function main() {
    ...
    console.log('\n===========================================')
    console.log('MIP-R32: Proposal Calldata Generator')
    console.log('===========================================\n')
    ...
    const markdownPath = path.join(__dirname, '../../../docs/MIP-R32.md')
    const description = fs.readFileSync(markdownPath, 'utf-8')

    console.log('✅ Loaded full markdown proposal from docs/MIP-R32.md')
